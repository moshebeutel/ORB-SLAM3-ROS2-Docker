  ...
  std::ostream & out)
{
  ...
  {
    out << "map_pitch: ";
    rosidl_generator_traits::value_to_yaml(msg.map_pitch, out);
    out << ", ";
  }
  ...
  {
    out << "map_roll: ";
    rosidl_generator_traits::value_to_yaml(msg.map_roll, out);
    out << ", ";
  }
  ...
  {
    out << "map_yaw: ";
    rosidl_generator_traits::value_to_yaml(msg.map_yaw, out);
    out << ", ";
  }
  ...
  {
    out << "ground_color_red: ";
    rosidl_generator_traits::value_to_yaml(msg.ground_color_red, out);
    out << ", ";
  }

  // member: ground_color_green
  {
    out << "ground_color_green: ";
    rosidl_generator_traits::value_to_yaml(msg.ground_color_green, out);
    out << ", ";
  }

  // member: ground_color_blue
  {
    out << "ground_color_blue: ";
    rosidl_generator_traits::value_to_yaml(msg.ground_color_blue, out);
    out << ", ";
  }
  ...
  {
    out << "z_thresh_min: ";
    rosidl_generator_traits::value_to_yaml(msg.z_thresh_min, out);
    out << ", ";
  }
