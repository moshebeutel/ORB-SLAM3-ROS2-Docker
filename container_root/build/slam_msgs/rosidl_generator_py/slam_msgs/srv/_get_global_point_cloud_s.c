...
bool slam_msgs__srv__get_global_point_cloud__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // map_pitch
    PyObject * field = PyObject_GetAttrString(_pymsg, "map_pitch");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->map_pitch = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // map_roll
    PyObject * field = PyObject_GetAttrString(_pymsg, "map_roll");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->map_roll = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // map_yaw
    PyObject * field = PyObject_GetAttrString(_pymsg, "map_yaw");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->map_yaw = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  ...
  {  // ground_color_red
    PyObject * field = PyObject_GetAttrString(_pymsg, "ground_color_red");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->ground_color_red = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // ground_color_green
    PyObject * field = PyObject_GetAttrString(_pymsg, "ground_color_green");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->ground_color_green = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // ground_color_blue
    PyObject * field = PyObject_GetAttrString(_pymsg, "ground_color_blue");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->ground_color_blue = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // z_thresh_min
    PyObject * field = PyObject_GetAttrString(_pymsg, "z_thresh_min");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->z_thresh_min = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // z_thresh_max
...
PyObject * slam_msgs__srv__get_global_point_cloud__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // map_pitch
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->map_pitch);
    {
      int rc = PyObject_SetAttrString(_pymessage, "map_pitch", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // map_roll
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->map_roll);
    {
      int rc = PyObject_SetAttrString(_pymessage, "map_roll", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // map_yaw
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->map_yaw);
    {
      int rc = PyObject_SetAttrString(_pymessage, "map_yaw", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // ground_color_red
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->ground_color_red);
    {
      int rc = PyObject_SetAttrString(_pymessage, "ground_color_red", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // ground_color_green
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->ground_color_green);
    {
      int rc = PyObject_SetAttrString(_pymessage, "ground_color_green", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // ground_color_blue
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->ground_color_blue);
    {
      int rc = PyObject_SetAttrString(_pymessage, "ground_color_blue", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // z_thresh_min
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->z_thresh_min);
    {
      int rc = PyObject_SetAttrString(_pymessage, "z_thresh_min", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
